            ...
            <div class="box">
                <form action="<?=ADMIN;?>/product/edit" method="post" data-toggle="validator">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="brand_id">Родительский бренд</label>
                            <?php new \app\widgets\brand\Brand([
                                'tpl' => WWW . '/menu/selectbrand.php',
                                'container' => 'select',
                                'cache' => 0,
                                'cacheKey' => 'admin_select',
                                'class' => 'form-control',
                        ...
                        <div class="form-group" id="modif-groupe">
                            <div class="box-body">
                                <label for="modif_title"><input type="checkbox" <?php if(!empty($modif)):?>
                                        ...
                                        <?php foreach ($modif as $item) : ?>
                                            <div class="row mod-del">
                                                 ...
                                                 <div class="col-xs-2" id="modif_price">
                                                   <input type="text" name="modif[price][]" class="form-control" placeholder="цена" value="<?=$item['price'];?>">
                                                 </div>
                                               <div class="col-xs-2" id="modif_old_price">
                                                  <input type="text" name="modif[old_price][]" class="form-control" placeholder="Старая цена" value="<?=$item['old_price'];?>">
                                              </div>
