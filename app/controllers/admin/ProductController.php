...
class ProductController extends AppController
{
        public function indexAction()
        {
            ...
            $products = \R::getAll("SELECT product.*, category.title AS cat, brand.title AS brand FROM product
                    JOIN category ON category.id = product.category_id 
                    JOIN brand ON brand.id = product.brand_id ORDER BY product.brand_id LIMIT $start, $perpage");
        ...
        public function editAction()
        {
            ...
            $this->set(compact('product', 'filter', 'related_product', 'gallery','modif'));
        }
